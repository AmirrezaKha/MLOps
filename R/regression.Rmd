...
# Load necessary libraries
library(leaps)
library(MASS)  # For AIC and BIC functions

# Load the data (ensure the path is correct)
vwcars <- read.csv("../data/vwscars.csv")
...
aic_values <- numeric(nrow(subsets_summary$outmat))
bic_values <- numeric(nrow(subsets_summary$outmat))
